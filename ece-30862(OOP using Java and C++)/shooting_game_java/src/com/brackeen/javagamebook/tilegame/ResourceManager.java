...
public class ResourceManager {
    ...
    private LinkedList<Sprite> b = new LinkedList<Sprite>();
    ...
    */
        ...
        throws IOException
    {
        ...
        for (int y=0; y<height; y++) {
            ...
            for (int x=0; x<line.length(); x++) {
                ...
                // check if the char represents a sprite
                	...
                	addSprite(newMap,explodSprite,x,y);
                }
        ...
        // add  bullets' list to the map
        
        LinkedList<Sprite> bulletList = new LinkedList<Sprite>();
        System.out.println("Adding Bullet...");
        
        for (int i = 0; i < 10000 ; i++) {
        	Sprite currBullet = (Sprite)bulletSprite.clone();
        	bulletList.add(currBullet);
            //System.out.println(bulletList.getLast());
        	newMap.setBullet(bulletList.get(i));
        } 
    ...
    public void loadCreatureSprites() {
        ...
        for (int i=0; i<4; i++) {
            ...
            //TODO
            bulletAnim[i] = createBulletAnim(bulletImage);
        }
        ...
        // TODO
        bulletSprite = new Bullet(bulletAnim[0],bulletAnim[0],
        		bulletAnim[0],bulletAnim[0]);
    }
    ...
    private void loadPowerUpSprites() {
        ...
        //bullet.addFrame(loadImage("Bullet.png"),150);
        ...
        anim = new Animation();
        anim.addFrame(loadImage("exploding.png"),150);
        explodSprite = new PowerUp.explod(anim);
